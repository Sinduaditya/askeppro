...
<style>
    ...
    .input-float-label label {
        position: absolute;
        pointer-events: none;
        left: 3.25rem; /* Adjust for icon width */
        top: 0.75rem;
                                    ...
                                    <div class="form-group">
                                        <div class="input-float-label">
                                            ...
                                            <input type="text" id="medical_record_number" name="medical_record_number"
                                                   ...
                                                   value="{{ old('medical_record_number') }}" placeholder=" " required>
                                            <label for="medical_record_number">Nomor Rekam Medis<span class="required-indicator">*</span></label>
                                            <i class="fas fa-check-circle validation-icon valid"></i>
                                            <i class="fas fa-exclamation-circle validation-icon invalid"></i>
                                        </div>
                                        ...
                                        <div class="form-hint">
                                            <i class="fas fa-info-circle"></i>
                                            Format yang disarankan: RM-YYYYMMDD-XXX
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-float-label">
                                            ...
                                            <label for="birth_date">Tanggal Lahir<span class="required-indicator">*</span></label>
                                        </div>
                                        @error('birth_date')
                                            <div class="invalid-feedback">
                                                <i class="fas fa-exclamation-triangle"></i>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-float-label">
                                            ...
                                            <label for="gender">Jenis Kelamin<span class="required-indicator">*</span></label>
                                        </div>
                                        @error('gender')
                                            <div class="invalid-feedback">
                                                <i class="fas fa-exclamation-triangle"></i>
                                    ...
                                    <div class="form-group">
                                        <div class="input-float-label">
                                            ...
                                            <select id="blood_type" name="blood_type" class="form-select @error('blood_type') is-invalid @enderror">
                                                ...
                                                <option value="Unknown" {{ old('blood_type') == 'Unknown' ? 'selected' : '' }}>Tidak Diketahui</option>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        <div class="input-float-label">
                                            ...
                                            <textarea id="address" name="address" class="form-control @error('address') is-invalid @enderror"
                                                      rows="3" placeholder=" ">{{ old('address') }}</textarea>
                                    ...
                                    <div class="form-group">
                                        <div class="input-float-label">
                                            ...
                                            <textarea id="notes" name="notes" class="form-control @error('notes') is-invalid @enderror"
                                                      rows="3" placeholder=" ">{{ old('notes') }}</textarea>
